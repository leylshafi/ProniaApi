...
namespace ProniaApi.Persistence.Data.Migrations
{
    ...
    [Migration("20240107182410_AddedRefreshToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProniaApi.Domain.Entities.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ProniaApi.Domain.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProniaApi.Domain.Entities.ProductTag", b =>
                {
                    ...
                    b.HasOne("ProniaApi.Domain.Entities.Tag", "Tag")
                        .WithMany("ProductTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
